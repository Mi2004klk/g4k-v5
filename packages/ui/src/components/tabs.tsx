...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start sm:justify-center rounded-[var(--radius)] bg-muted p-1 text-muted-foreground overflow-x-auto thin-scrollbar max-w-full w-full sm:w-auto",
      className
    )}
    {...props}
  />
