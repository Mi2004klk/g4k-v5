...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['key' => 'password.expiry_days', 'value' => json_encode(90), 'category' => 'security'],
            ...
            ['key' => 'password_history_limit', 'value' => json_encode(3), 'category' => 'security'],
            ['key' => 'session.max_devices', 'value' => json_encode(3), 'category' => 'security'],
            ['key' => 'session.max_concurrent', 'value' => json_encode(3), 'category' => 'security'],
            ...
            ['key' => 'suspicious_login.enabled', 'value' => json_encode(false), 'category' => 'security'],
            ['key' => 'suspicious_login.whitelist_ips', 'value' => json_encode(''), 'category' => 'security'],
            ['key' => 'suspicious_login.whitelist_locations', 'value' => json_encode(''), 'category' => 'security'],
            ['key' => 'suspicious_login.blacklist_ips', 'value' => json_encode(''), 'category' => 'security'],
            ['key' => 'suspicious_login.blacklist_locations', 'value' => json_encode(''), 'category' => 'security'],
